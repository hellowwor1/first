...
int main(int argc, char *argv[]) {
  ...
  */
  ...
  video_to_r0 = p2p_v2.Install(servers.Get(0), routers.Get(0));
  r0_to_r2 = p2p_v2.Install(routers.Get(0), routers.Get(2));
