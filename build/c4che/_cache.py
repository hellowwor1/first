...
CC = ['/usr/bin/gcc']
CCDEFINES = ['_DEBUG']
CCFLAGS = ['-O0', '-ggdb', '-g3', '-Wall', '-Werror', '-Wno-error', '-std=c++11', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['energy', 'ipv6', 'channel-models', 'tcp', 'traffic-control', 'tutorial', 'realtime', 'error-model', 'udp', 'matrix-topology', 'routing', 'stats', 'wireless', 'socket', 'udp-client-server', 'naming']
...
NS3_CONTRIBUTED_MODULES = ['ns3-dash']
NS3_ENABLED_CONTRIBUTED_MODULES = ['ns3-dash']
...
NS3_EXECUTABLE_PATH = ['/home/light/ns-allinone-3.34/ns-3.34/build/src/fd-net-device', '/home/light/ns-allinone-3.34/ns-3.34/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/11', '/home/light/ns-allinone-3.34/ns-3.34/build/lib', '/home/light/ns-allinone-3.34/ns-3.34/build']
...
cfg_files = ['/home/light/ns-allinone-3.34/ns-3.34/build/ns3/config-store-config.h', '/home/light/ns-allinone-3.34/ns-3.34/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
